...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default='/mnt/guangchao/dataset/imagenet-1k/ImageNet/ILSVRC2012_train/data')
    parser.add_argument("--data_split", type=str, default='imagenet_train')
    parser.add_argument("--output_path", type=str, default="siglip_vae_features")
